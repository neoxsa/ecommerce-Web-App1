        ...
        <div className='bg-amber-50 w-full h-auto py-10 '>
            ...
            <div className='h-auto mx-10 py-5 px-2 gap-6 grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-2 xl:grid-cols-4 xl:grid-rows-1 '>
                <span className='flex flex-row items-center gap-4 w-full sm:w-auto'>
                    <Trophy className='w-10 h-10 lg:w-15 lg:h-15 text-gray-900' />
                    <div>
                ...
                <span className='flex flex-row  items-center gap-4 w-full sm:w-auto'>
                    <BadgeCheck className='w-10 h-10 lg:w-15 lg:h-15 text-gray-900' />
                    <div>
                ...
                <span className='flex flex-row  items-center gap-4 w-full sm:w-auto'>
                    <Truck className='w-10 h-10 lg:w-15 lg:h-15 text-gray-900' />
                    <div>
                ...
                <span className='flex flex-row items-center gap-4 w-full sm:w-auto'>
                    <Headphones className='w-10 h-10 lg:w-15 lg:h-15 text-gray-900' />
                    <div>
