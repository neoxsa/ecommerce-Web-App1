          ...
          <div className='w-full lg:w-2/3'>
            ...
            <div className='space-y-4 mt-4'>
              {cartProduct.map((product) => (
                <div key={product.id.productId} className='bg-white rounded-lg relative flex justify-center shadow-sm p-4'>
                  <div className='grid grid-cols-1 sm:grid-cols-5 gap-4 items-center'>
                    {/* Product Image */}
                    <div className='col-span-2 sm:col-span-1 '>
                      <img
                        className='w-24 h-24 sm:w-30 sm:h-30 object-cover rounded-lg mx-auto'
                    ...
                    {/* Product Name */}
                    <div className='col-span-2 sm:col-span-1'>
                      <p className='text-sm font-medium text-center inline-flex flex-wrap w-50 sm:w-auto'>{product.name.productTitle}</p>
                    </div>
          ...
          <div className='w-full lg:w-1/3 mt-8 lg:mt-0'>
            <div className='bg-amber-50 rounded-lg p-6 sticky top-4'>
              ...
              <div className='space-y-4'>
                ...
                <button
                  onClick={() => cartProduct.length > 0 && navigate('/checkout')}
